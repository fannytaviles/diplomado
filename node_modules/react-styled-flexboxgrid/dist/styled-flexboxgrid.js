(function (global, factory) {
	...
	(factory((global.styled = global.styled || {}),global.React,global.styled));
...
function makeMedia(media) {
  return function () {
    return styled.css(_templateObject$1, media, styled.css.apply(undefined, arguments));
  };
}
...
var Grid = styled__default(function (props) {
  return React__default.createElement(props.tagName || 'div', createProps(Grid.PropTypes, props));
})(_templateObject, function (p) {
  return p.fluid && styled.css(_templateObject2, function (p) {
    return config(p).outerMargin + 'rem';
  }, function (p) {
    return config(p).outerMargin + 'rem';
  });
}, function (p) {
  return !p.fluid && styled.css(_templateObject3, DIMENSION_NAMES.map(function (t) {
...
var ModificatorType = React.PropTypes.oneOf(DIMENSION_NAMES);

var Row = styled__default(function (props) {
  return React__default.createElement(props.tagName || 'div', createProps(Row.PropTypes, props));
...
var ModificatorType$1 = React.PropTypes.oneOfType([React.PropTypes.number, React.PropTypes.bool]);
...
var DimensionPropTypes = DIMENSION_NAMES.reduce(function (propTypes, dimension) {
  ...
  propTypes[dimension + 'Offset'] = React.PropTypes.number;
  return propTypes;
}, {});

var Col = styled__default(function (props) {
  return React__default.createElement(props.tagName || 'div', createProps(Col.PropTypes, props));
